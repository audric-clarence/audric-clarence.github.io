  ...
  return (
    <div className="main-bg">
        ...
        <header id="hero" className="hero">
          ...
          >
            <source src={mode === 'dark' ? "https://media.githubusercontent.com/media/PierPaudric/audric-website/main/public/hero-dark.mp4" : "https://media.githubusercontent.com/media/PierPaudric/audric-website/main/public/hero-light.mp4"} type="video/mp4" />
